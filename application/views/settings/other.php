            ...
            <div class="">
                <div class="row">
                    <div class="col-md-12">
                        <div class="box">
                            <div class="box-body ">
                                <a href="<?php echo base_url(); ?>index.php/settings/add_other"  type="button" class="btn btn-success pull-right ">
                                    Add New Product
                                </a>
                            </div>
                            <div class="box-body">
                                    ...
                                    if(!empty($products)){
                                        foreach ($products as $product) { ?>
                                            <tr>
                                                ...
                                                <td class="center">
                                                    <?php echo form_open('settings/delete_other', 'id="frm1' . $product['Id'] . '"'); ?>
                                                    <span class="btn-group">
                                                        <a href="<?php echo base_url(); ?>index.php/settings/add_other/<?php echo $product['Id'] ?>"
