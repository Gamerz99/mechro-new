...
?>
 <div class="content-wrapper" >
     <section class="content-header">
         ...
         <ol class="breadcrumb">
             <li class="fa fa-dashboard active"> Add Gallery</li>
         </ol>
     </section>
         <section class="content">
             <div class="box box-default">
                 <div class="box-header with-border">
                     <h3 class="box-title">please add/edit gallery</h3>
                 </div>

                 <div class="box-body">
                     <?php echo form_open_multipart('settings/save_gallery', 'id="form1" data-parsley-validate class=""'); ?>
                     <div class="row">
                         <div class="col-md-6 form-group">
                             ...
                             echo form_dropdown('Category', $category, $gallery['Category'], 'class="form-control col-md-7 col-xs-12"');
                             ?>
                         </div>
                         <div class="col-md-6 form-group">
