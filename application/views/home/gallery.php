...
<div class="load">
            ...
            <header id="header" class="hoc clear">
                ...
                <nav id="mainav" class="fl_right">
                    <ul class="clear">
                        ...
                        <li class="active"><a href="<?php echo base_url(); ?>index.php/gallery">Gallery</a></li>
    ...
    <div class="wrapper">
        <div class="container cont"><br>
            <h6 class="heading center">GALLERY</h6><hr>
            <section class="portfolio-area section-gap" id="portfolio">
                <ul class="nav nav-tabs">
                    <li class="active"><a data-toggle="tab" href="#machine">Machine</a></li>
                    <li><a data-toggle="tab" href="#construction">Construction</a></li>
                    <li><a data-toggle="tab" href="#other">Other</a></li>
                </ul><br>

                <div class="tab-content">
                    <div id="machine" class="tab-pane fade in active">
                        <div class="tz-gallery">
                            <div class="row">
                                <?php
                                foreach ($machines as $machine){
                                    ?>
                                    <div class="col-sm-6 col-md-4 col-md-4c">
                                        <a class="lightbox" href="<?php echo base_url(); ?>gallery/<?php echo $machine['Image']; ?>">
                                            <img src="<?php echo base_url(); ?>gallery/<?php echo $machine['Image']; ?>" alt="Park">
                                        </a>
                                    </div>
                                    <?php
                                }
                    ...
                    <div id="construction" class="tab-pane fade in ">
                        <div class="tz-gallery">
                            <div class="row">
                                <?php
                                foreach ($constructions as $construction){
                                    ?>
                                    <div class="col-sm-6 col-md-4 col-md-4c">
                                        <a class="lightbox" href="<?php echo base_url(); ?>gallery/<?php echo $construction['Image']; ?>">
                                            <img src="<?php echo base_url(); ?>gallery/<?php echo $construction['Image']; ?>" alt="Park">
                                        </a>
                                    </div>
                                    <?php
                                }
                        ...
                        <div class="tz-gallery">
                            <div class="row">
                                ...
                                foreach ($others as $other){
                                    ?>
                                    <div class="col-sm-6 col-md-4 col-md-4c">
                                        <a class="lightbox" href="<?php echo base_url(); ?>gallery/<?php echo $other['Image']; ?>">
                                            <img src="<?php echo base_url(); ?>gallery/<?php echo $other['Image']; ?>" alt="Park">
                                        </a>
                                    </div>
                                    <?php
                                }
