...
<div class="load">
                    ...
                    <ul class="clear">
                        ...
                        <li class="active"><a class="drop" href="#">Products</a>
                            <ul>
                                ...
                                <li class="active"><a href="#">Other</a>
                                    <ul>
                ...
                foreach ($products as $product){
                    ...
                    <div class="col-md-4 col-sm-6">
                        <article>
                            ...
                            <footer>
                                <div class="fl_center">
                                    <a class="btn" href="<?php echo base_url(); ?>index.php/other/detail/<?php echo $product['Id']?>">View</a>
                                </div>
                            </footer>
                        </article>
                    </div>
    ...
    <ul class="pagination justify-content-center">
        <?php if($page!=1){ ?>
            <li class="page-item">
                <?php $previous=$page-1?>
                <a class="page-link" href="<?php echo base_url(); ?>index.php/other/category/<?php echo $category['Id'] ?>/<?php echo $previous?>">Previous</a>
            </li>
            <li class="page-item "><a class="page-link" href="<?php echo base_url(); ?>index.php/other/category/<?php echo $category['Id'] ?>/<?php echo $page-1?>"><?php echo $page-1 ?></a></li>
        <?php }?>
        <li class="page-item active"><a class="page-link " href="<?php echo base_url(); ?>index.php/other/category/<?php echo $category['Id'] ?>/<?php echo $page?>"><?php echo $page ?></a></li>
        <?php
        if($page>=$last){
        } else{?>
            <li class="page-item"><a class="page-link" href="<?php echo base_url(); ?>index.php/other/category/<?php echo $category['Id'] ?>/<?php echo $page+1?>"><?php echo $page+1 ?></a></li>
            <li class="page-item">
                <?php $next=$page+1?>
                <a class="page-link" href="<?php echo base_url(); ?>index.php/other/category/<?php echo $category['Id'] ?>/<?php echo $next?>">Next</a>
            </li>
        <?php }?>
    </ul>
    <?php
