        ...
        <section class="hoc container clear"><br>
            ...
            <div class="col-md-3">
                ...
                <nav class="sdb_holder">
                    <ul>
                        <a class="btn btn-block btn-side inverse btn-card" href="<?php echo base_url(); ?>index.php/machinery/category/4"><i class="fa fa-arrow-circle-right"></i> Tea Machinery</a>
                        <a class="btn btn-block btn-side inverse btn-card" href="<?php echo base_url(); ?>index.php/machinery/category/5"><i class="fa fa-arrow-circle-right"></i> Conveyors</a>
                        <a class="btn btn-block btn-side inverse btn-card" href="<?php echo base_url(); ?>index.php/machinery/category/6"><i class="fa fa-arrow-circle-right"></i> Dust Collector</a>
                        <a class="btn btn-block btn-side inverse btn-card" href="<?php echo base_url(); ?>index.php/machinery/category/7"><i class="fa fa-arrow-circle-right"></i> Exhaust Fan</a>
                        <a class="btn btn-block btn-side inverse btn-card" href="<?php echo base_url(); ?>index.php/machinery/category/8"><i class="fa fa-arrow-circle-right"></i> Packers</a>
                        <a class="btn btn-block btn-side inverse btn-card" href="<?php echo base_url(); ?>index.php/machinery/category/9"><i class="fa fa-arrow-circle-right"></i> Filters</a>
                    </ul>
                </nav><br>
                <h6 class="red"><i class="fa fa-snowflake-o"></i> Construction</h6>
                <nav class="sdb_holder">
                    <ul>
                        <a class="btn btn-block btn-side inverse btn-card" href="<?php echo base_url(); ?>index.php/construction/category/10"><i class="fa fa-arrow-circle-right"></i> Equipment</a>
                        <a class="btn btn-block btn-side inverse btn-card" href="<?php echo base_url(); ?>index.php/construction/category/11"><i class="fa fa-arrow-circle-right"></i> Roofing Sheets</a>
                        <a class="btn btn-block btn-side inverse btn-card" href="<?php echo base_url(); ?>index.php/construction/category/12"><i class="fa fa-arrow-circle-right"></i> Gates</a>
                        <a class="btn btn-block btn-side inverse btn-card" href="<?php echo base_url(); ?>index.php/construction/category/13"><i class="fa fa-arrow-circle-right"></i> Roller Doors</a>
                        <a class="btn btn-block btn-side inverse btn-card" href="<?php echo base_url(); ?>index.php/construction/category/14"><i class="fa fa-arrow-circle-right"></i> Hand Railing</a>
                        <a class="btn btn-block btn-side inverse btn-card" href="<?php echo base_url(); ?>index.php/construction/category/15"><i class="fa fa-arrow-circle-right"></i> Building</a>
                    </ul>
                </nav><br>
                <h6 class="red"><i class="fa fa-snowflake-o"></i> Other</h6>
                <nav class="sdb_holder">
                    <ul>
                        <a class="btn btn-block btn-side inverse btn-card" href="<?php echo base_url(); ?>index.php/other/category/16"><i class="fa fa-arrow-circle-right"></i> Land</a>
                        <a class="btn btn-block btn-side inverse btn-card" href="<?php echo base_url(); ?>index.php/other/category/17"><i class="fa fa-arrow-circle-right"></i> Vehicles</a>
                    </ul>
                </nav>
            </div>
            <div class="col-md-9">
